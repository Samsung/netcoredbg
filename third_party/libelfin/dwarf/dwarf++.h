...
public:
        ...
        die() : tag(DW_TAG::array_type), cu(nullptr), abbrev(nullptr), offset(0), next(0) { }
...
public:
         ...
         */
        value() : cu(nullptr), form(DW_FORM::addr), typ(type::invalid), offset(0) { }
...
public:
        ...
        expr_result() :
                location_type(type::empty),
                value(0),
                implicit(nullptr),
                implicit_len(0)
        {}
        expr_result(type location_type_, taddr value_) :
                location_type(location_type_),
                value(value_),
                implicit(nullptr),
                implicit_len(0)
        {}
